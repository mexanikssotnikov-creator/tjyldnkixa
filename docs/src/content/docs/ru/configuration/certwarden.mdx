...
6. Войдём в систему, используя логин admin и пароль password
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/mexanikssotnikov-creator/tjyldnkixa/master/docs/src/assets/en/certwarden/certwarden_login.png" 
...
7. Попадём на главную страницу
    ...
    ![Cert Warden dashboard](https://raw.githubusercontent.com/mexanikssotnikov-creator/tjyldnkixa/master/docs/src/assets/en/certwarden/certwarden_dashboard.png)
...
5. В поле `API Access Method` выбираем `API Token`. Инструкцию по созданию токена с правами `Zone:Edit` можно найти в [официальной документации Cloudflare](https://developers.cloudflare.com/fundamentals/api/get-started/create-token/)
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/mexanikssotnikov-creator/tjyldnkixa/master/docs/src/assets/en/certwarden/certwarden_new_challenge_provider.png" 
...
7. Выскочит новое окно c нашим Private Key, так же нажимаем на кнопку Submit
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/mexanikssotnikov-creator/tjyldnkixa/master/docs/src/assets/en/certwarden/certwarden_private_key.png" 
...
9. Откроется окно с данными аккаунта
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/mexanikssotnikov-creator/tjyldnkixa/master/docs/src/assets/en/certwarden/certwarden_acme_accounts.png" 
...
7. Нажимаем на кнопку Submit
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/mexanikssotnikov-creator/tjyldnkixa/master/docs/src/assets/en/certwarden/certwarden_certificates.png" 
...
8. Внизу появится окно ACME Orders
      ...
      ![Cert Warden ACME Orders](https://raw.githubusercontent.com/mexanikssotnikov-creator/tjyldnkixa/master/docs/src/assets/en/certwarden/certwarden_acme_orders.png)
...
11. Переходим в раздел `Dashboard` и видим, что сертификат получен и сколько дней осталось до окончания срока действия
      ...
      ![Cert Warden Dashboard](https://raw.githubusercontent.com/mexanikssotnikov-creator/tjyldnkixa/master/docs/src/assets/en/certwarden/certwarden_dashboard_certificate.png) 
...
2. `CW_CLIENT_AES_KEY_BASE64` - указываем ключ, сгенерированный в разделе `Certificates` --> `Post Processing` --> `Client AES Key`. Нажмите кнопку `GENERATE`, чтобы получить ключ
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/mexanikssotnikov-creator/tjyldnkixa/master/docs/src/assets/en/certwarden/certwarden_aes_key.png" 
...
2. В панели управления Cloudflare для вашего домена certwarden.yourdomain.com указываем IP-адрес сервера Cert Warden в сети Netbird
      ...
      ![Cert Warden Cloudflare](https://raw.githubusercontent.com/mexanikssotnikov-creator/tjyldnkixa/master/docs/src/assets/en/certwarden/certwarden_ip_netbird.png) 
